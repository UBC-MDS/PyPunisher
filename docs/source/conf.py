...
# -*- coding: utf-8 -*-
#
# pypunisher documentation build configuration file, created by
# sphinx-quickstart
#
...
htmlhelp_basename = 'pypunisherdoc'
...
latex_documents = [
    (master_doc, 'pypunisher.tex', 'pypunisher Documentation',
     'Jill Cates, Avinash Prabhakaran, Tariq Hassan', 'manual'),
]
...
man_pages = [
    (master_doc, 'pypunisher', 'pypunisher Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pypunisher', 'pypunisher Documentation',
     author, 'pypunisher', 'One line description of project.',
     'Miscellaneous'),
]
...
pdf_documents = [(master_doc,
                  u'pypunisher',
                  u'pypunisher Documentation',
                  u'Jill Cates, Avinash Prabhakaran, Tariq Hassan')
    , ]
